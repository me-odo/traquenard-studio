...
| `composite.invoke`   | 1       | Invoke an inspectable declarative subgraph through typed ports. | composite id, typed arguments | typed bindings | control       | UNKNOWN_COMPOSITE      |
