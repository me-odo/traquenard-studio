...
> Generated from `packages/engine-core/src/index.ts`. Do not edit manually. Run `pnpm docs:axioms`.
...
| `composite.invoke`   | 1       | Invoke an inspectable declarative subgraph.  | composite id                 | —          | control       | UNKNOWN_COMPOSITE      |
