...
const sequential: GameDefinition = {
  ...
  root: {
    ...
    steps: [
      ...
      { id: 'play-turn', kind: 'composite.invoke', compositeId: 'turn.challenge' },
      { id: 'end-a', kind: 'end' },
    ],
  },
};
...
const cardRound: GameDefinition = {
  ...
  composites: [
    {
      ...
      implementation: {
        ...
        steps: [
          ...
          { id: 'draw', kind: 'collection.draw', collectionVariable: 'deck', output: 'handCard' },
          {
            id: 'private-card',
            kind: 'present',
  ...
  root: {
    ...
    kind: 'sequence',
    steps: [
      { id: 'deal-round', kind: 'composite.invoke', compositeId: 'round.deal-one' },
      { id: 'end-c', kind: 'end' },
    ],
  },
};
