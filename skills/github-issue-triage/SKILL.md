...
When investigation yields a durable decision, record it in architecture documentation/ADR and close the corresponding issue. Never perform destructive external actions or push without authorization.
